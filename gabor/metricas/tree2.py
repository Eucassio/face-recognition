...
def classificar(files, vetor, y_train, f, numFeatures, numsplit):
    ...
    f = open("/media/eucassio/dados/facedatabase/vetores_extras/wild_recortada_manualmente/resultadocomn_estimators1000.csv", 'a')
...
def selecao(numFeatures, numSplit, X1,y1):
    ...
    #print(featuresFull.shape)
    classificar('WILD_22112016_REDIMENSIONADA__0_100_6_4x4_5x8_15x15__concatenado_13_3500_sub_250x14_.txt', featuresFull, y1, f, numFeatures, numSplit)
...
c=0
X1, y1 = load_svmlight_file(path + 'WILD_22112016_REDIMENSIONADA__0_100_6_4x4_5x8_15x15__concatenado_13_3500_sub_250x14_.txt')
X1 = X1.toarray()
print X1.shape[1]
