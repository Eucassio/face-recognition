...
for i = 0: 0
    fileRead = strcat('hist_gabor_curvo_TOTAL_HORIZ_test2_crop_100_14_8x8_5x16_30x30.txt');
    disp(fileRead);
    [heart_scale_label, heart_scale_inst] = libsvmread(fileRead);    
    
    fileRead2 = strcat('hist_gabor_curvo_TOTAL_HORIZ_oclusao_100_12_8x8_5x16_30x30.txt');
    disp(fileRead2);
