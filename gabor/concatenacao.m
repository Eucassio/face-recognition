...
for j=2000:500:10000
    ...
    for i = 1:4
        ...
        heart_scale_instreino = [heart_scale_instreino; red_dim];
        heart_scale_labeltreino = [heart_scale_labeltreino; heart_scale_label1];
        clearvars heart_scale_inst1 heart_scale_label1 red_dim;
        disp('--------------------------------LIDO--------------------------------------');
    end
    ...
    name = strcat('hist_gabor_curvo_TOTAL_oclusao_100_12_8x8_5x16_30x30_', num2str(j) ,'.txt');
