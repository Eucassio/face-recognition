...
treinoRed = zeros(dx, dy/(16/tamPCA));
numFrequencias = 5;
...
for i = 1:dx
    ...
    C = out2(:);
    C = C';
    treinoRed(i,1: size(treinoRed,2)) = C;
end


libsvmwrite([name '_final2_' num2str(size(treinoRed,2)) '.txt'], heart_scale_labeltreino, sparse(treinoRed));
disp('Fim')
